...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            <p class="login-box-msg">Now <span style="color: #00c0ef;font-size: large"><?php echo $_SESSION['firstName'] ?></span> Choose a pic for your identity</p>
            <div class="row">
                <div class="widget-user-image col-md-4" ></div>
                <div class="widget-user-image col-md-4" >
                <img class="img-circle elevation-2" src="dist/img/default_pic.jpg" style="width: 100%;" alt="User Avatar">
            </div>
            </div>
            <form action="picForm.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="input-group-append">
                            <span class="input-group-text" id="" style="height: 38px;">Upload</span>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-4">
